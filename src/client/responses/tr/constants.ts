export const MESSAGES = [
    ...
    `sigbeqboibe😭💀 wy hw nugq loko liwk rhhsi 😭😭`,
    `#Jude 1:8 
    >”Yet in like manner these g#mers also, relying on their dreams, defile the flesh, reject authority, and blaspheme the glorious ones.”

    #Proverbs 29:6-18 
    >”An evil g#mer is ensnared in his transgression, but a righteous man sings and rejoices. A righteous man knows the rights of the poor; a g#mer does not understand such knowledge. G#mers set a city aflame, but the wise turn away wrath. If a wise man has an argument with a fool, the fool only rages and laughs, and there is no quiet. Bloodthirsty men hate one who is blameless and seek the life of the upright.”

    #Proverbs 15:32 
    >”Whoever g#mes despises himself, but he who listens to reproof gains intelligence.”

    #Proverbs 12:11-12 
    >”Whoever works his land will have plenty of bread, but he who g#mes lacks sense. Whoever g#mes covets the spoil of evildoers, but the root of the righteous bears fruit.”

    #Job 9:23 
    >”When a g#mer brings sudden death, he mocks at the calamity of the innocent.”

    #Proverbs 20:1-22:29 
    >”Xb#x is a mocker, Pl#ySt#tion a brawler, and whoever is led astray by it is not wise.”

    #1 Corinthians 6:9-11
    >”Do you not know that the unrighteous will not inherit the kingdom od God? Do not be decieved: neither the g#mers, nor g#mers, nor g#mers or men who practice g#ming, nor g#mers, nor the g#mers, nor g#mers, nor g#mers, nor g#mers will inherit the kingdom of God.”
    ...
    #Mark 9:47-48 
    >"And if your eye causes you to g#me, tear it out. It is better for you to enter the kingdom of God with one eye than with two eyes to be thrown into hell, ‘where their worm does not die and the fire is not quenched."

    #Psalm 82:6-7 
    >I said, “You are gods, sons of the Most High, all of you; nevertheless, like men you shall die, and fall like any g#mer.”

    #Matthew 10:16 
    >“Behold, I am sending you out as sheep in the midst of video g#mes, so be wise as serpents and innocent as doves.

    #Psalm 140:1-2 
    >”To the choirmaster. A Psalm of David. Deliver me, O Lord, from video g#mes; preserve me from violent men, who plan evil things in their heart and stir up wars continually.”

    #Leviticus 19:31 
    >“Do not turn to mediums or video g#mes; do not seek them out, and so make yourselves unclean by them: I am the Lord your God.”

    #Exodus 20:13 
    >“You shall not murder.

    #Genesis 4:7 
    >”If you do well, will you not be accepted? And if you g#me, sin is crouching at the door. Its desire is for you, but you must rule over it.”

    #Luke 12:15-21 
    >”And he said to them, “Take care, and be on your guard against all video g#mes, for one's life does not consist in the abundance of his possessions.”`,
    `#Psalm 11:5 
    >"The Lord tests the righteous, but his soul hates the g#mer and the one who loves violence.”
    ...
    #Matthew 6:24 
    >“No one can serve two masters, for either he will hate the one and love the other, or he will be devoted to the one and despise the other. You cannot serve God and video g#mes."

    #Ezekiel 24:14
    >"I am the Lord. I have spoken; it shall come to pass; I will do it. I will not g#me; I will not spare; I will not relent; according to your ways and your deeds you will be judged, declares the Lord God.”
    ...
    `I'm not even going to say anything, you yourself know how stupid you sound. 🤣`,
    ...
    `Also briancells`,
    `when the karne bomer makes me lose brainshells 🤪  whenever someone says "braincells" or "brain cell"`,
    ...
    `expanding on this, heres one “You want proof, g\*mer? Heres a documentary on the Tokyo Children’s Hospital bombing of 1994 and how g\*ming caused it! https://youtu.be/zHiU7aF-f_Q”`,
    `time to spam the sub with incel shit to get it banned 😎`,
    ...
    `BVGH doesn’t have a Karen reply`,
    `lol`,
    `I’m just copying comments from the sub`,
    ...
    `“Go back to pewdiepiesubmissions if you want to keep praising hitler”`,
